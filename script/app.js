App = {
  ...
  initWeb3: async () => {
    try {
      ...
      if (provider) {
        ...
        App.web3 = new Web3(new Web3.providers.HttpProvider("https://rinkeby.infura.io/v3/94890e5bd20040fe861e18da383bb492"))
      }
  ...
  initContracts: async () => {
    ...
    if (App.networkId !== 56) {
      ...
      alert("Please switch to rinkeby Chain");
      return
    }
    ...
    App.airdropAddress = "0xD695713dcDCD821ed75763dDEA547FaF128C2180" // RKBY
